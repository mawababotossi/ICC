    ...
    public static ArrayList<Post> parsePosts(JSONObject jsonObject) {
        ...
        try{
            ...
            for (int i = 0; i < postArray.length(); i++) {
                ...
                post.setTitle(postObject.optString("title", "N/A").replace("&#8217;", "'"));
                ...
                //post.setCategoriesString(postObject.getJSONObject("categories").toString());
                post.setCustomFields(postObject.getJSONObject("custom_fields"));
