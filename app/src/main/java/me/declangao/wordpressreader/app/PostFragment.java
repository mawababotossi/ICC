    ...
    public void setUIArguments(final Bundle args) {
        getActivity().runOnUiThread(new Runnable() {
            public void run() {
                ...
                Boolean isEvent = args.getBoolean("isEvent");
                Boolean isAudio = args.getBoolean("isAudio");
                ...
                // First, some CSS
                String html = "<style>img{max-width:100%;height:auto;} " +"div.content{text-align:justify;} " +
                        "iframe{width:100%;}</style> ";
                // Article Title

                // Date & author
                if(isAudio) html += "<h4>" + date.substring(0, 10)  + "</h4>";
