...
import me.declangao.wordpressreader.adaptor.MyRecyclerViewPostsAdaptor;
...
public class RecyclerViewFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private MyRecyclerViewPostsAdaptor mAdaptor;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdaptor = new MyRecyclerViewPostsAdaptor(postList, new MyRecyclerViewPostsAdaptor.OnItemClickListener() {
            @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Log.d("WOX", "HomeBack pressed");
        switch (item.getItemId()) {
            case R.id.action_share:
                return true;
            case android.R.id.home:
                Log.d("WOX", "Home pressed from List");
                mListener.onHomePressedFromList();
                return true;
            default:
